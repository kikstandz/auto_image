...
center           = "54.711769589683875,20.452491764444858"
radius           = "1258.5982824459518"   #search radius
...
def send_wikimapia_request(page):
    ...
    api_url += "category=railway&categories_or=&categories_and=&distance=%s&" % radius
